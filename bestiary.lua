...
local B={seen={},unread={},dirty=false,entries={
 ...
 {id='skeleton_fish',boss=true,name='Léviathan d’ivoire',art='skeleton_head',world=7,text='Sa tête domine le côté gauche. Fonce sur une mine pour la décrocher, puis laisse son aspiration l’entraîner dans sa bouche : chaque mine avalée lui retire deux vies et interrompt son souffle. Cinq impacts suffisent. Les mines explosent au contact sans élan, et contre les murs une fois décrochées. Évite ses salves de dents et traverse l’ouverture mobile de ses vagues de pression. À mi-vie, les attaques accélèrent. L’œil devient rouge pendant l’aspiration : se faire avaler est mortel, même sans charge. Profite de son bref recul après une explosion pour te replacer.'},
