...
local B={seen={},unread={},dirty=false,entries={
 ...
 {id='magma_spawner',trap=true,name='Flaque d’invocation',art='magma_pool',world=2,text='Cette poche rouge verdâtre invoque régulièrement une larve de magma. Son bouillonnement annonce la prochaine naissance.'},
 {id='magma_larva',name='Larve de magma',art='magma_larva',world=2,text='Elle te poursuit très vite et contourne les murs. Elle clignote avant d’exploser après quelques secondes, ou dès qu’elle te touche. L’explosion laisse du poison mortel au sol jusqu’au recommencement du niveau.'},
 ...
 {id='wasp',boss=true,name='Guêpe solitaire',art='wasp_down',world=2,text='Invulnérable en vol, elle lance des dards et invoque des guêpes. Au sol, touche son corps pour lui retirer une vie sans mourir. Elle redécolle après un coup ou si tu attends trop. Son venin vert ralentit.'},
 {id='waspling',name='Petite guêpe',art='waspling_down',world=2,text='Petite guêpe cuivrée aux yeux verts, invoquée par la guêpe solitaire. Elle reste présente jusqu’à la fin du niveau, même après la mort du boss. Son contact est mortel.'},
 ...
 {id='skeleton_fish',boss=true,name='Léviathan d’ivoire',art='skeleton_head',world=7,text='Ses os restent fixes : seule sa tête se déplace. Elle ouvre régulièrement la bouche pour tout aspirer, puis recrache ses prises. Fais-toi électrocuter par un fil bleu, puis entre dans sa bouche ouverte : elle te recrache et perd une vie. Les cercles éclairent seulement tant que tu restes dessus et ne chargent pas ton corps. Sans charge électrique, la bouche et les os sont mortels.'},
 ...
 {id='lava',trap=true,name='Flaque de lave',art='lava',world=2,text='Une flaque immobile et mortelle. Contourne son bord incandescent.'},
